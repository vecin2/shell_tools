...
FILES=$(svn st AddCoreChannelsReportingFacts/Implementation/Monitors/ AddCoreChannelsReportingFacts/Implementation/ReportingData/InteractionReportingData* | awk '{print $2}')
echo "$FILES"
